...
const EnigmaLeaderboard = ({ activeSubTab, setActiveSubTab }) => {
    ...
    async function loadLeaderboards() {
        ...
        const res1 = await fetch("http://localhost:4000/load/enigma-first-year");
        const fy = await res1.json();

        const res2 = await fetch("http://localhost:4000/load/enigma-non-first-year");
        const nf = await res2.json();

        const res3 = await fetch("http://localhost:4000/load/codenigma");
